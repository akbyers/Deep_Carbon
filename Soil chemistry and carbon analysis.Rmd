...
C_stocks <- read.csv("//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Carbon stocks/Carbon_stocks_both_fractions.csv") #data showing % of total soil profile's C allocated to each depth increment
View(C_stocks)
...
```{r}
#exporting plot
png(file = "//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/C_allocation.png", width = 1200, height = 500)
...
```{r load files}
chemistry.data <- read.csv("//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Soil chemistry/Soil_chemistry_working_datasheet.csv")
...
capture.output(chemistry_aov2, file = "//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Soil chemistry/R files/ANOVA_depth.csv")
...
capture.output(chemistry_aov2, file = "//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Soil chemistry/R files/ANOVA_transect.csv")
```
...
capture.output(chemistry_Letters, file = "//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Soil chemistry/R files/Tukey_byDepth.csv")
...
capture.output(chemistry_Letters2, file = "//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/Soil chemistry/R files/Tukey_byTransect.csv")
```
...
#combine and export
```{r}
stableAndRadiocarbon <- rbind(Delta13C, radiocarbon, radiocarbonAge, Total_C)
write.csv(stableAndRadiocarbon, "//scionfile/data/Carbon & Climate Change/Deep soil C/Data & Results/Lab data/13C and Radiocarbon/Datafiles/DataSummary.csv")
```
...
##exporting total C, delta 13C, radiocarbon 14C and CRA plots
```{r merge plots and export}
carbonPlot <- TotalC.plot + Delta13C.plot + x14C.plot + CRA.plot

png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/StableandRadioC.png", width = 600, height = 600)
plot(carbonPlot)
```
