...
```{r read in data}
Topsoil_core <- read.csv("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Topsoil_core_genera.csv") 
Subsoil_core <- read.csv("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Subsoil_core_genera.csv") 
Allsoil_core <- read.csv("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Allsoil_core_genera.csv") 
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Topsoil_interkingdom.png", width = 900, height = 900)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Topsoil_interkingdom.png", width = 600, height = 600)
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Subsoil_interkingdom.png", width = 900, height = 900)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Subsoil_interkingdom.png", width = 600, height = 600)
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Fungal_topsoil.png", width = 700, height = 700)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Topsoil_fungi.png", width = 600, height = 600)
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Fungal_subsoil.png", width = 700, height = 700)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Subsoil_fungi.png", width = 600, height = 600)
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Bacteria_topsoil.png", width = 700, height = 700)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Topsoil_bacteria.png", width = 600, height = 600)
...
#png("C:/Users/ByersA/OneDrive - Scion/Deep Carbon R/Network Analysis/Bacteria_subsoil.png", width = 700, height = 700)
png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Subsoil_bacteria.png", width = 600, height = 600)
...
```
```{r}
network_stats_plot <- Degree.plot + APL.plot + ClusCo.plot + NeighSize.plot + Betweenness.plot
#png("//scionfile/data/Carbon & Climate Change/Deep soil C/Submission/Puruki Deep C/Report figures/Supplementary figures/network_stats_plot.png", width = 900, height = 500)
plot(network_stats_plot)
```
