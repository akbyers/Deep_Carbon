...
```{r}
path <- "C:/Users/ByersA/OneDrive - scion/Soil deep C data/ITS sequencing data/AGRF_CAGRF21067226_JV8MM"
list.files(path)
```
...
```{r}
cutadapt <- "C:/Users/ByersA/OneDrive - scion/Soil deep C data/ITS sequencing data/ITS DADA2/cutadapt" # CHANGE ME to the cutadapt path on your machine
...
# ------filter and trim-----
```{r}
newpath <-"/home/saddison/cutadapt"
...
# assign taxonomy
taxa <- assignTaxonomy(seqtab.nochim, "/home/saddison/sh_general_release_dynamic_s_04.02.2020.fasta", multithread = TRUE, tryRC = TRUE)
...
```{r}
newpath <- "C:/Users/ByersA/OneDrive - scion/Soil deep C data/ITS sequencing data/ITS DADA2"
filtFs <- file.path(newpath, "filtered", paste0(sample.names, "_F_filt.fastq.gz"))
filtRs <- file.path(newpath, "filtered", paste0(sample.names, "_R_filt.fastq.gz"))
names(filtFs) <- sample.names
names(filtRs) <- sample.names
...
# assign taxonomy
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "C:/Users/ByersA/OneDrive - scion/Soil deep C data/ITS sequencing data/ITS DADA2/sh_general_release_dynamic_10.05.2021.fasta", multithread = FALSE, tryRC = TRUE)
```
